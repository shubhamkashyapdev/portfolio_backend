/*! For license information please see 16.964fc79da6555d700d00.js.LICENSE.txt */
  ...
  [16],
  {
    29016: (e, t, n) => {
      ...
      const f = u()((e) => {
        const {
          ...
          [k] = (0, a.useState)(() =>
            i.languages[y]
              ? (e) => (0, i.highlight)(e, i.languages[y])
              : (e) => e
          ),
          F = t || n,
          w = (0, a.useCallback)((e, t) => l(e, { ...t, required: r }), [l, r]),
          {
            value: _,
            showError: A,
            setValue: S,
          ...
          E = ["field-type", "code", h, A && "error", u && "read-only"]
            .filter(Boolean)
            .join(" ");
        return a.createElement(
          "div",
          { className: E, style: { ...f, width: m } },
          a.createElement(g.Z, { showError: A, message: P }),
          a.createElement(c.Z, {
            htmlFor: `field-${F}`,
            label: x,
            required: r,
          ...
          a.createElement(s(), {
            id: `field-${F.replace(/\./gi, "__")}`,
            value: _ || "",
            onValueChange: u ? () => null : S,
            highlight: k,
            padding: 25,
            style: {
          ...
          a.createElement(p.Z, { value: _, description: v })
        );
      });
    },
    35433: () => {
          ...
          for (var p in n)
            if (n.hasOwnProperty(p) && n[p]) {
              ...
              for (var f = 0; f < d.length; ++f) {
                ...
                for (
                  var k = h.pattern || h, F = a.next, w = l;
                  F !== t.tail && !(g && w >= g.reach);
                  w += F.value.length, F = F.next
                ) {
                  var _ = F.value;
                  ...
                  if (!(_ instanceof s)) {
                    var A,
                      S = 1;
                    if (v) {
                      if (!(A = i(k, w, e, y)) || A.index >= e.length) break;
                      var P = A.index,
                        E = A.index + A[0].length,
                        C = w;
                      for (C += F.value.length; P >= C; )
                        C += (F = F.next).value.length;
                      if (((w = C -= F.value.length), F.value instanceof s))
                        continue;
                      for (
                        var $ = F;
                        $ !== t.tail && (C < E || "string" == typeof $.value);
                        $ = $.next
                      )
                        S++, (C += $.value.length);
                      S--, (_ = e.slice(w, C)), (A.index -= w);
                    } else if (!(A = i(k, 0, _, y))) continue;
                    P = A.index;
                    var j = A[0],
                      O = _.slice(0, P),
                      z = _.slice(P + j.length),
                      L = w + _.length;
                    g && L > g.reach && (g.reach = L);
                    var D = F.prev;
                    if (
                      (O && ((D = u(t, D, O)), (w += O.length)),
                      c(t, D, S),
                      (F = u(t, D, new s(p, m ? r.tokenize(j, m) : j, b, j))),
                      z && u(t, F, z),
                      S > 1)
                    ) {
                      var K = { cause: p + "," + f, reach: L };
                      o(e, t, n, F.prev, w, K),
                        g && K.reach > g.reach && (g.reach = K.reach);
                    }
                  }
                }
              }
    ...
    40460: function (e, t, n) {
      ...
      var c = l(n(67294)),
        ...
        v = "npm__react-simple-code-editor__textarea",
        b =
            ...
            return (
              ...
              (t._recordChange = function (e, n) {
                ...
                var o = t._history,
                  ...
                  u = o.offset;
                if (l.length && u > -1) {
                  t._history.stack = l.slice(0, u + 1);
                  var c = t._history.stack.length;
                  if (c > h) {
                    var g = c - h;
                    (t._history.stack = l.slice(g, c)),
                      (t._history.offset = Math.max(t._history.offset - g, 0));
                  }
                }
                var p = Date.now();
                if (n) {
                  var d = t._history.stack[t._history.offset];
                  if (d && p - d.timestamp < 3e3) {
                    var f = /[^a-z0-9]([a-z0-9]+)$/i,
                      m =
                        null ===
                          (a = t._getLines(d.value, d.selectionStart).pop()) ||
                        void 0 === a
                          ? void 0
                          : a.match(f),
                      y =
                        null ===
                          (r = t._getLines(e.value, e.selectionStart).pop()) ||
                        void 0 === r
                          ? void 0
                          : r.match(f);
                    if (
                      (null == m ? void 0 : m[1]) &&
                      (null === (i = null == y ? void 0 : y[1]) || void 0 === i
                        ? void 0
                        : i.startsWith(m[1]))
                    )
                      return void (t._history.stack[t._history.offset] = s(
                        s({}, e),
                        { timestamp: p }
                      ));
                  }
                }
                t._history.stack.push(s(s({}, e), { timestamp: p })),
                  t._history.offset++;
              }),
              ...
              (t._applyEdits = function (e) {
                var n = t._input,
                  a = t._history.stack[t._history.offset];
                a &&
                  n &&
                  (t._history.stack[t._history.offset] = s(s({}, a), {
              ...
              (t._undoEdit = function () {
                var e = t._history,
                  ...
                  r = n[a - 1];
                r &&
                  (t._updateInput(r), (t._history.offset = Math.max(a - 1, 0)));
              }),
              (t._redoEdit = function () {
                ...
                r &&
                  (t._updateInput(r),
                  (t._history.offset = Math.min(a + 1, n.length - 1)));
              }),
              (t._handleKeyDown = function (e) {
                ...
                if (!i || (i(e), !e.defaultPrevented)) {
                  ...
                  var o = e.currentTarget,
                    ...
                    c = o.selectionEnd,
                    h = (r ? " " : "\t").repeat(a);
                  if (9 === e.keyCode && !s && t.state.capture)
                    if ((e.preventDefault(), e.shiftKey)) {
                      var v = (F = t._getLines(l, u)).length - 1,
                        b = t._getLines(l, c).length - 1,
                        x = l
                          .split("\n")
                          .map(function (e, t) {
                            return t >= v && t <= b && e.startsWith(h)
                      ...
                      if (l !== x) {
                        ...
                        t._applyEdits({
                          value: x,
                          selectionStart: (null == k ? void 0 : k.startsWith(h))
                            ? u - h.length
                            : u,
                          selectionEnd: c - (l.length - x.length),
                        });
                      }
                    } else if (u !== c) {
                      var F,
                        w = (F = t._getLines(l, u)).length - 1,
                        _ = t._getLines(l, c).length - 1;
                      k = F[w];
                      t._applyEdits({
                        value: l
                          .split("\n")
                          .map(function (e, t) {
                            return t >= w && t <= _ ? h + e : e;
                          })
                          .join("\n"),
                        selectionStart: k && /\S/.test(k) ? u + h.length : u,
                        selectionEnd: c + h.length * (_ - w + 1),
                      });
                    } else {
                      var A = u + h.length;
                      t._applyEdits({
                        value: l.substring(0, u) + h + l.substring(c),
                        selectionStart: A,
                        selectionEnd: A,
                      });
                    }
                    ...
                    var S = u !== c;
                    if (l.substring(0, u).endsWith(h) && !S) {
                      e.preventDefault();
                      A = u - h.length;
                      t._applyEdits({
                        value: l.substring(0, u - h.length) + l.substring(c),
                        selectionStart: A,
                        selectionEnd: A,
                      });
                    }
                    ...
                    if (u === c) {
                      var P = t._getLines(l, u).pop(),
                        E = null == P ? void 0 : P.match(/^\s+/);
                      if (null == E ? void 0 : E[0]) {
                        e.preventDefault();
                        var C = "\n" + E[0];
                        A = u + C.length;
                        t._applyEdits({
                          value: l.substring(0, u) + C + l.substring(c),
                          selectionStart: A,
                          selectionEnd: A,
                        });
                      }
                    ...
                    !(y
                      ? e.metaKey && e.keyCode === g
                      : e.ctrlKey && e.keyCode === g) ||
                    e.shiftKey ||
                    e.altKey
                      ? (y
                          ? e.metaKey && e.keyCode === g && e.shiftKey
                          : m
                          ? e.ctrlKey && 89 === e.keyCode
                          : e.ctrlKey && e.keyCode === g && e.shiftKey) &&
                        !e.altKey
              ...
              (t._handleChange = function (e) {
                var n = e.currentTarget,
                  ...
                  s = n.selectionEnd;
                t._recordChange(
                  { value: a, selectionStart: r, selectionEnd: s },
                  !0
                ),
                  t.props.onValueChange(a);
              }),
          ...
          return (
            ...
            (t.prototype.render = function () {
              ...
              return c.createElement(
                "div",
                s({}, E, { style: s(s({}, k.container), a) }),
                c.createElement("textarea", {
                  ref: function (t) {
                    return (e._input = t);
                  },
                  style: s(s(s({}, k.editor), k.textarea), C),
                  className: v + (l ? " ".concat(l) : ""),
                  id: o,
                  value: n,
                  ...
                  s(
                    {
                      className: P,
                      "aria-hidden": "true",
                      style: s(s(s({}, k.editor), k.highlight), C),
                    },
                    "string" == typeof $
