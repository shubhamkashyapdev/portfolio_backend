    ...
    28571: (e, t, a) => {
      ...
      const m = n()((e) => {
        const {
          ...
          Z = a || t,
          v = (0, l.useCallback)((e, t) => n(e, { ...t, required: r }), [n, r]),
          w = (0, o.Z)({
            path: Z,
            validate: v,
          ...
          { value: L, showError: b, setValue: V, errorMessage: _ } = w,
          k = ["field-type", "email", p, b && "error", m && "read-only"]
            .filter(Boolean)
            .join(" ");
        return l.createElement(
          "div",
          { className: k, style: { ...u, width: C } },
          l.createElement(s.Z, { showError: b, message: _ }),
          l.createElement(i.Z, {
            htmlFor: `field-${Z.replace(/\./gi, "__")}`,
            label: y,
            required: r,
          }),
          l.createElement("input", {
            id: `field-${Z.replace(/\./gi, "__")}`,
            value: L || "",
            onChange: V,
            disabled: Boolean(m),
            placeholder: E,
          ...
          l.createElement(c.Z, { value: L, description: f })
        );
      });
    },
    76067: (e, t, a) => {
      ...
      const d = s()((e) => {
        const {
          ...
          E = t || a,
          h = (0, l.useCallback)((e, t) => s(e, { ...t, required: i }), [s, i]),
          {
            value: f,
            showError: g,
            formProcessing: y,
            setValue: Z,
            errorMessage: v,
          } = (0, r.Z)({ path: E, validate: h, enableDebouncedValue: !0 }),
          w = ["field-type", "password", m, g && "error"]
            .filter(Boolean)
            .join(" ");
        return l.createElement(
          "div",
          { className: w, style: { ...d, width: u } },
          l.createElement(o.Z, { showError: g, message: v }),
          l.createElement(n.Z, {
        ...
        f = () => {
          const e = (0, r.k6)(),
            { user: t, setToken: a } = (0, i.a)(),
            {
              admin: {
                user: f,
                components: { beforeLogin: g, afterLogin: y } = {},
              },
              serverURL: Z,
              routes: { admin: v, api: w },
              collections: L,
            } = (0, o.Z)(),
            b = L.find(({ slug: e }) => e === f);
          return t
            ? l.createElement(
                ...
                l.createElement(
                  ...
                  l.createElement(
                    ...
                    " ",
                    l.createElement(n.Link, { to: `${v}/logout` }, "log out"),
                    " ",
                    "first."
                  ),
                  ...
                  l.createElement(
                    C.Z,
                    { el: "link", buttonStyle: "secondary", to: v },
                    "Back to Dashboard"
                  )
                )
              )
            : l.createElement(
                ...
                Array.isArray(g) &&
                  g.map((e, t) => l.createElement(e, { key: t })),
                ...
                Array.isArray(y) &&
                  y.map((e, t) => l.createElement(e, { key: t }))
              );
        };
    },
    15205: (e, t, a) => {
      ...
      const u = "verify",
        p = ({ collection: e }) => {
          ...
          if (
            ((0, l.useEffect)(() => {
              !(async function () {
                const e = await fetch(`${C}/api/${t}/verify/${p}`, {
                  method: "POST",
                });
                y(e);
              })();
          ...
          return l.createElement(
            ...
            l.createElement(
              "div",
              { className: "verify__brand" },
              l.createElement(i.Z, null)
            ),
            l.createElement(
              "h2",
              null,
              200 === (null == g ? void 0 : g.status)
                ? "Verified Successfully"
                : 202 === (null == g ? void 0 : g.status)
                ? "Already Activated"
                : "Unable To Verify"
            ),
            f &&
              ...
              l.createElement(
                c.Z,
                { el: "link", buttonStyle: "secondary", to: `${E}/login` },
                "Login"
              )
          );
        };
