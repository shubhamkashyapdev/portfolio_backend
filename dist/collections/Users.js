        ...
        return __awaiter(void 0, void 0, void 0, function () {
          ...
          return __generator(this, function (_c) {
            if (operation === "create") {
              ...
              if (
                reqUserRole !== "admin" &&
                !roles_1.userRoles.includes(data.role)
              ) {
              ...
              if (data.role !== "admin") {
                ...
                (0, sendEmail_1.default)({
                  ...
                  html: "<h1>Your Verification Code is: ".concat(
                    token,
                    "</h1>"
                  ),
                });
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                body = req.body;
                if (
                  !(body === null || body === void 0 ? void 0 : body.id) ||
                  !(body === null || body === void 0 ? void 0 : body.otp)
                ) {
                  return [
                    2 /*return*/,
                    res
                      .status(400)
                      .json({
                        message: "Please provide a valid otp and user ID",
                      }),
                  ];
                }
                _a.label = 1;
