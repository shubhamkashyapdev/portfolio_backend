...
var sendEmilPath = path_1.default.resolve(__dirname, "collections/hooks/sendEmail.ts");
var mockEmailModulePath = path_1.default.resolve(__dirname, "mocks/sendEmail.ts");
exports.default = (0, config_1.buildConfig)({
    ...
    admin: {
        ...
        webpack: function (config) {
            var _a;
            return (__assign(__assign({}, config), { resolve: __assign(__assign({}, config.resolve), { alias: __assign(__assign({}, config.resolve.alias), (_a = {}, _a[sendEmilPath] = mockEmailModulePath, _a)) }) }));
        },
    },
